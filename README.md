...
This implementation is a proof of concept. There may be areas in the code that were implemented insecurely for the sake of code readibility and understanding. We are not responsible for any damages if the code is used for commercial purposes.
