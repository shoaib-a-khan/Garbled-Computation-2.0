...
{
    std::ifstream fin("Randoms_B.txt");
...
{
    std::ifstream fin("AlphaRandoms_B.txt");
    std::istream_iterator<long> start(fin), end;
    std::vector<long> numbers(start, end);
...
{
    static std::ifstream pin("Permutations_PB.txt");
    static std::ifstream din("Permutations_DB.txt");
    long temp;
    Pi_P.clear();
    Pi_D.clear();
    for(int i=0; i < n_p; i++)
...
{
    static std::ifstream upin("U_PB.txt");
    static std::ifstream udin("U_DB.txt");
    static std::ifstream rpin("R_PB.txt");
    static std::ifstream rdin("R_DB.txt");
    static std::ifstream pipin("Pi_diff_R_PA_PB.txt");
    static std::ifstream pidin("Pi_diff_R_DA_DB.txt");
...
{
    static std::ofstream fout("Debug_B.txt");
    static int count = 0;
...
{
    static int count=0;
    static std::ofstream fout("DebugTranslate_B.txt");
    for(int i = 0; i < n_p; i++)
    {
